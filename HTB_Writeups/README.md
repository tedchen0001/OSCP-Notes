...
| Traverxec | Nostromo, [HOMEDIRS](https://www.gsp.com/cgi-bin/man.cgi?section=8&topic=nhttpd#HOMEDIRS) (www_public), hidden folder in user's folder, <br> cracking passphrase  | ```/etc/sudoers```, journalctl without PIPE, <br> resize (less, vi) |
