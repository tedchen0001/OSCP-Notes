...
| StreamIO | subdomain, SQLi, wfuzz(parameter), LFI(php://filter), page uses eval | [forwarding service](https://github.com/jpillora/chisel), SQL Server 1433, [firefox credentials](https://github.com/lclevy/firepwd), bloodhound, <br>Add-DomainObjectAcl(add member to CORE STAFF) ||
