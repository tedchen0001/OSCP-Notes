...
Forest, Active, Monteverde, Reel, Mantis, Blackfield, Search, APT, Support, Outdated, Scrambled, StreamIO
...
| *StreamIO | subdomain, SQLi, wfuzz(parameter, cookie), LFI(php://filter), page uses eval | [forwarding service](https://github.com/jpillora/chisel), SQL Server 1433, [firefox credentials](https://github.com/lclevy/firepwd), bloodhound analysis, <br>Add-DomainObjectAcl(add member to group) | :white_check_mark: |
