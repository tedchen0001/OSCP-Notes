...
| Shibboleth | wfuzz, udp, IPMI, hashcat 7300, <br> zabbix RCE, password reuse | MariaDB |
| Shocker | [ShellShock](https://nvd.nist.gov/vuln/detail/cve-2014-6271) extensions ```sh``` ```pl``` | sudo list |
